...
export default function Transportation() {
  ...
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-slate-100">
      ...
      <img
        src={iair}
        alt="Digital information screens at transportation hub"
    ...
    <div className="grid grid-cols-3 gap-8 pt-12 max-w-lg">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Better Wayfinding</p>
      </div>

      <div>
        <p className="text-3xl font-bold text-slate-900">35%</p>
        <p className="text-sm text-slate-500 mt-1">Lower Passenger Queries</p>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative">
          <div className="rounded-3xl overflow-hidden shadow-xl">
            <img
              src={a1}
              alt="Passengers viewing digital departure boards"
        ...
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 leading-tight">
            Make Passenger Journeys Smoother
          </h2>

          <p className="mt-6 text-slate-600 max-w-xl leading-relaxed">
            Real-time digital displays keep passengers informed about schedules, delays, 
            gate changes, and wayfinding — reducing confusion and improving satisfaction.
          </p>

          <ul className="mt-8 space-y-4">
            <li className="flex items-start gap-3">
              <span className="flex items-center justify-center w-6 h-6 rounded-full bg-slate-900 text-white text-sm">✓</span>
              <span className="text-slate-700">Live arrival & departure boards</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="flex items-center justify-center w-6 h-6 rounded-full bg-slate-900 text-white text-sm">✓</span>
              <span className="text-slate-700">Wayfinding for terminals & platforms</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="flex items-center justify-center w-6 h-6 rounded-full bg-slate-900 text-white text-sm">✓</span>
              <span className="text-slate-700">Service alerts & emergency announcements</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="flex items-center justify-center w-6 h-6 rounded-full bg-slate-900 text-white text-sm">✓</span>
              <span className="text-slate-700">Reduced staff workload for inquiries</span>
            </li>
          </ul>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-4 text-slate-600">
              Digital signage solutions for airports, railway stations, bus terminals, and metros.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group rounded-3xl border border-slate-200 bg-white overflow-hidden shadow-sm hover:shadow-xl transition">
              <div className="h-48 overflow-hidden">
                <img src={a1} alt="Departure Boards" className="w-full h-full object-cover group-hover:scale-105 transition duration-500" />
              </div>
              <div className="p-8">
                ...
                <p className="text-slate-600">
                  Live schedules and platform information for passengers.
                </p>
              </div>
            </div>
            ...
            <div className="group rounded-3xl border border-slate-200 bg-white overflow-hidden shadow-sm hover:shadow-xl transition">
              <div className="h-48 overflow-hidden">
                <img src={t1} alt="Wayfinding Screens" className="w-full h-full object-cover group-hover:scale-105 transition duration-500" />
              </div>
              <div className="p-8">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">
                  Wayfinding Screens
                ...
                <p className="text-slate-600">
                  Guide passengers across large terminals.
                </p>
              </div>
            </div>
            ...
            <div className="group rounded-3xl border border-slate-200 bg-white overflow-hidden shadow-sm hover:shadow-xl transition">
              <div className="h-48 overflow-hidden">
                <img src={b4} alt="Ticketing Kiosks" className="w-full h-full object-cover group-hover:scale-105 transition duration-500" />
              </div>
              <div className="p-8">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">
                  Ticketing Kiosks
                ...
                <p className="text-slate-600">
                  Enable self-service ticketing and information access.
                </p>
              </div>
            </div>
      ...
      <section className="relative bg-[#0b0b0e] py-28">
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          <h2 className="mt-4 text-3xl md:text-4xl lg:text-5xl font-bold text-white">
            Transportation That Keeps People Moving
          </h2>
          <p className="mt-5 text-slate-400 max-w-3xl mx-auto">
            Deliver reliable, real-time information at scale across your transport network.
          </p>
          ...
          <div className="mt-20 grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h4 className="mt-2 font-semibold text-white">Better Navigation</h4>
              <p className="mt-3 text-slate-400 text-sm">
                Clear wayfinding reduces passenger confusion.
              </p>
            </div>

            <div className="flex flex-col items-center text-center">
              <p className="text-4xl font-bold text-white">35%</p>
              <h4 className="mt-2 font-semibold text-white">Lower Inquiry Load</h4>
              <p className="mt-3 text-slate-400 text-sm">
                Passengers find information themselves.
              </p>
            </div>

            <div className="flex flex-col items-center text-center">
              <p className="text-4xl font-bold text-white">40%</p>
              <h4 className="mt-2 font-semibold text-white">Faster Information Delivery</h4>
              <p className="mt-3 text-slate-400 text-sm">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-3 text-slate-400 text-sm">
                Always-on displays for critical travel info.
              </p>
            </div>
